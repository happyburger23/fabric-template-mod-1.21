...
public class ModSounds {
    ...
    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(TemplateMod121.MOD_ID, name);
    ...
    public static void registerModSounds() {
        TemplateMod121.LOGGER.info("Registering Mod Sounds for " + TemplateMod121.MOD_ID);
    }
}
